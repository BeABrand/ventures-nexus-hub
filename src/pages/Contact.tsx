          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 bg-card rounded-xl p-6 shadow-elegant hover-lift">
              ...
              <div className="bg-card rounded-2xl p-6 shadow-elegant">
                <h3 className="font-semibold mb-4">Our Reach</h3>
                <div className="aspect-video bg-gradient-to-br from-primary/10 to-accent/10 rounded-xl flex items-center justify-center">
                  <p className="text-muted-foreground text-center px-4">
                    Serving clients globally across<br />multiple time zones
                  </p>
                </div>
              </div>
            </div>
